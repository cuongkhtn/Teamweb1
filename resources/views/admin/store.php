...
<html>
	<head>
		...
		<link href="qt64_admin/css/style.css" rel="stylesheet" type="text/css"  media="all" />
		<meta name="keywords" content="Mobilestore iphone web template, Android web template, Smartphone web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
		<link href='//fonts.googleapis.com/css?family=Londrina+Solid|Coda+Caption:800|Open+Sans' rel='stylesheet' type='text/css'>
		<script src="qt64_admin/js/jquery.min.js"></script>
		<script type="text/javascript" src="js/jquery.livequery.js"></script>
		<link href="qt64_admin/css/style1.css" rel="stylesheet" />
...
$(document).ready(function() {
	...
	$('.add-to-cart-button').click(function(){
		...
		else
		{
			...
			$('#cart_wrapper .cart-info').append('<div class="shopp" id="each-'+thisID+'"><div class="label">'+itemname+'</div><div class="shopp-price"> $<em>'+itemprice+'</em></div><span class="shopp-quantity">1</span><img src="qt64_admin/images/remove.png" class="remove" /><br class="all" /></div>');
...
<div align="left" style="min-height:800px;">
	...
	<div id="wrap" align="center">
		...
		<ul>
			<li id="1">
				<img src="qt64_admin/images/m1.jpg" class="items" alt="" />
			...
			<li id="2">
				<img src="qt64_admin/images/m2.jpg" class="items" alt="" />
			...
			<li id="3">
				<img src="qt64_admin/images/m4.jpg" class="items" alt="" />
				
				<br clear="all" />
				<div>Product-Name</div>
			</li>
			<li id="4">
				<img src="qt64_admin/images/m6.jpg" class="items" alt="" />
			...
			<div class="detail-view" id="detail-1">
				...
				<img src="qt64_admin/images/m1.jpg" class="detail_images" alt="" />
			...
			<div class="detail-view" id="detail-2">
				...
				<img src="qt64_admin/images/m2.jpg" class="detail_images" alt="" />
			...
			<div class="detail-view" id="detail-3">
				...
				<img src="qt64_admin/images/m4.jpg" class="detail_images" alt="" />
			...
			<div class="detail-view" id="detail-4">
				...
				<img src="qt64_admin/images/m6.jpg" class="detail_images" alt="" />
			...
			<li id="7">
				<img src="qt64_admin/images/m7.jpg" class="items" alt="" />
			...
			<div class="detail-view" id="detail-13">
				...
				<img src="qt64_admin/images/13.jpg" class="detail_images" alt="" />
		...
		<div class="footer">
			...
			<div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4 footer-lastgrid">
					...
					<h3>Follow Us:</h3>
					<ul>
					 	<li><a href="#"><img src="qt64_admin/images/twitter.png" title="twitter" />Twitter</a></li>
					 	<li><a href="#"><img src="qt64_admin/images/facebook.png" title="Facebook" />Facebook</a></li>
					 	<li><a href="#"><img src="qt64_admin/images/rss.png" title="Rss" />Rss</a></li>
					 </ul>
				</div>
			</div>
		</div>
