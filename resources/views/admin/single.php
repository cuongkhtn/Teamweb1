...
<html>
	<head>
		...
		<script src="qt64_admin/js/jqzoom.pack.1.0.1.js" type="text/javascript"></script>
		<link rel="stylesheet" href="qt64_admin/css/flexslider.css" type="text/css" media="screen" />
		<script src="qt64_admin/js/imagezoom.js"></script>
		<!-- FlexSlider -->
					<script defer src="qt64_admin/js/jquery.flexslider.js"></script>
					<script>
		    ...
		    <div class="content-grids">
		    	<div class="details-page">
		    		<div class="back-links">
		    			<ul>
		    				<li><a href="#">Home</a><img src="qt64_admin/images/arrow.png" alt=""></li>
		    				<li><a href="#">Product</a><img src="qt64_admin/images/arrow.png" alt=""></li>
		    				<li><a href="#">Product-Details</a><img src="qt64_admin/images/arrow.png" alt=""></li>
		    			</ul>
		    		</div>
		    	</div>
		    	<div class="detalis-image">
		    		<div class="flexslider">
						<ul class="slides">
							<li data-thumb="qt64_admin/images/m11.jpg">
								<div class="thumb-image"> <img src="qt64_admin/images/m11.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="qt64_admin/images/m11.jpg">
								<div class="thumb-image"> <img src="qt64_admin/images/m11.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
		    	...
		    	<div class="detalis-image-details">
		    		...
		    		<div class="share">
		    			<ul>
		    				...
		    				<li> <a href="#"><img src="qt64_admin/images/twitter.png" title="Twiiter" />Twiiter</a></li>
