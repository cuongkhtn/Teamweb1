					...
					<tbody>
						...
						<tr class="cart_item">
							<td class="product-name" style="width: 300px">
								<div class="media">							
									<div class="media-body">
										<p class="font-large table-title" style="text-align: center;">{{$item->name}}</p>
										<img class="pull-left" src="qt69admin/image/product/{{$item->img}}" alt="Cường" width="30%" height="30%" style="margin-left:35% " >
									</div>
							...
							<td class="product-remove">
								<a href="{{route('decart',$item->id)}}" class="remove" title="Remove this item"><i class="fa fa-trash-o"></i></a>
							</td>
						</tr>
							@endforeach
					</tbody>
						<div style="float: right;">{{$cart->links()}}</div>
					<tfoot>
						<tr>

							<td colspan="6" class="actions" style="padding-left: 850px">

								<div class="coupon">
									<label for="coupon_code" style="line-height:150%">Mã giảm giá</label> 
									<input type="text" name="coupon_code" value="" placeholder="Nhập ở đây"> 
									<button type="submit" class="beta-btn primary" name="apply_coupon">Đồng ý <i class="fa fa-chevron-right"></i></button>
								</div>
							</td>
						</tr>
					</tfoot>
